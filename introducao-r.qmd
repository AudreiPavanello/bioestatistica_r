...
O **R** é uma linguagem de programação e ambiente de software livre para computação estatística e gráficos. Desenvolvido inicialmente por Ross Ihaka e Robert Gentleman na Universidade de Auckland, Nova Zelândia, o R se tornou uma das ferramentas mais populares para análise de dados, especialmente nas áreas de estatística, bioestatística e ciência de dados.
...
-   **Velocidade**: Pode ser mais lento que linguagens compiladas para grandes volumes de dados
-   **Consumo de Memória**: Armazena todos os dados na memória RAM
