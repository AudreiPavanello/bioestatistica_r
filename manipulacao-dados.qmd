...
4.  Calcule a taxa de mortalidade (%) por faixa etária (use intervalos de 10 anos)

5.  Crie um data frame limpo contendo apenas internações de pacientes idosos (≥60 anos) com todas as variáveis categóricas recodificadas de forma descritiva