...
- **Dados Disponíveis**: Os dados utilizados nos exemplos estão disponíveis na pasta `data/`
...
1. **R** (versão 4.0 ou superior): [https://cran.r-project.org/](https://cran.r-project.org/)
2. **RStudio** (versão recente): [https://posit.co/download/rstudio-desktop/](https://posit.co/download/rstudio-desktop/)
...
**Data de Publicação**: `r Sys.Date()`

**Versão do R utilizada**: `r R.version.string`
